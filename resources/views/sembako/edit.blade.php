            ...
            <div class="card-body">
                ...
                <form action="{{ route('sembako.update',$viewsembako->id)}}" method="post">
                    ...
                    <div class="form-group row">
                        ...
                        <input type="hidden" name="id" class="form-control" value="{{ $viewsembako->id}}">
                        <div class="col-sm-4">
                            <select class="form-control" name="nik" id="nik">
                                <option value="{{$viewsembako->nik_kk}}">{{$viewsembako->nik_kk}}|{{$viewsembako->nama_kk}}</option>
                    ...
                    <div class="card-footer text-center">
                        ...
                        <a href="{{ route('sembako.index') }}" class="btn btn-warning">BATAL</a>
                    </div>
                </form>
                @endforeach
            </div>
