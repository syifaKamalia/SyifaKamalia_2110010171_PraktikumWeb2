...
<a href="{{route('cetakPenduduk')}}" type="button" class="btn btn-info">
    Cetak Laporan
</a>
<hr>
            ...
            <tr>
                ...
                <td>
                    <div class="btn-group" role="group" arialabel="basic example">
                        ...
                        <form action="{{route('penduduk.destroy',$data->nik_kk)}}" method="POST" onsubmit="return confirm('Apakah yakinmenghapus data ini?')">
                            @csrf
                            @method('DELETE')
